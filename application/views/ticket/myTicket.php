    ...
    <div class="am-center" style="max-width:640px;margin-bottom:1rem">
        ...
        if (count($ticket) == 0) {
            ...
            foreach ($ticket as $t) {
                ...
                if ($t['status'] == 1) {
                    echo '<span class="am-badge am-badge-success am-radius">未使用</span>';
                }
                if ($t['status'] == 2) {
                    echo '<span class="am-badge am-badge-warning am-radius">已使用</span>';
                }
                if ($t['status'] == -1) {
                    echo '<span class="am-badge am-badge-danger am-radius">已作废</span>';
                }

                if ($t['class'] == 1) {
                    echo '<span class="am-badge am-badge-primary am-round">普通座</span>';
                }
                if ($t['class'] == 2) {
                    echo '<span class="am-badge am-badge-danger am-round">VIP 座</span>';
                }

                echo "<span class=\"am-badge am-badge-secondary am-radius\">$time</span>";
                if ($t['status'] == 2) {
                    echo "<span class=\"am-badge am-badge-secondary am-radius\">$time2</span>";
                }
...
<div class="am-modal am-modal-no-btn" tabindex="-1" id="qrcode-modal">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd" style="text-align:center">
            ...
            <div id="qrcode-url" class="ticket-qrcode" class="am-center" style="max-width:100%;"></div>
            入场时，您可以直接出示该二维码;
            <br>
            不要把二维码发送给别人哦！
        </div>
...
<script src="https://cdn.jsdelivr.net/npm/qrcodejs@1.0.0/qrcode.min.js" integrity="sha256-xUHvBjJ4hahBW8qN9gceFBibSFUzbe9PNttUvehITzY="
