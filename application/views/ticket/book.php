                    ...
                    <div class="am-u-lg-12">
                        <div class="am-form-group">
                            <div class="am-input-group">
                                ...
                                <input id="input-name" type="text" class="am-form-field" placeholder="姓名"
                                    data-validation-message="请填写正确的姓名" value="<?php echo $user['name'] ?>"
                                    required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="am-form-group">
                            <div class="am-input-group">
                                ...
                                <input id="input-phone" type="text" class="am-form-field js-pattern-mobile" placeholder="手机号"
                                    data-validation-message="请输入11位大陆手机号" value="<?php echo $user['phone'] ?>"
                                    required>
                            </div>
                        </div>
