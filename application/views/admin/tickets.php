...
<div class="fly-content" style="margin-top:1em">
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            ...
            <label class="am-checkbox">
                <input id="add-sms" type="checkbox" checked="checked" value="" data-am-ucheck checked>
                发送确认短信
            </label>
            <label class="am-checkbox am-danger">
                <input id="add-force" type="checkbox" value="" data-am-ucheck>
                强制发票（不管已有几张）
            </label>
        </div>
        <div class="am-modal-footer">
